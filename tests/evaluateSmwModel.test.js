...
const model = {
  meta: { version: "test-model", targetRows: 4, ridge: 1 },
  predictions: [
    { playerName: "Keeper", clubName: "Alpha", positionGroup: "GK", targetRating: 90, predictedRating: 89.5, error: -0.5, absoluteError: 0.5, matchReason: "exact-name", clubMismatch: false },
    { playerName: "Centre Back", clubName: "Alpha", positionGroup: "DEF", targetRating: 88, predictedRating: 90, error: 2, absoluteError: 2, matchReason: "initial-surname", clubMismatch: false },
    { playerName: "Midfielder", clubName: "Beta", positionGroup: "MID", targetRating: 84, predictedRating: 83, error: -1, absoluteError: 1, matchReason: "exact-name", clubMismatch: true },
    { playerName: "Forward", clubName: "Beta", positionGroup: "ATT", targetRating: 92, predictedRating: 95, error: 3, absoluteError: 3, matchReason: "club-tiebreak", clubMismatch: false }
  ]
};
...
test("formats SMW rating evaluation report", () => {
  ...
  assert.match(text, /Overall MAE: 1.625/);
