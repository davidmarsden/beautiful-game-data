...
const swaps = [
  ...
  { top80Slot: 78, reserveSlot: 91, promotedName: "Inter Miami CF" },
...
universe.version = "tbg-club-universe-v0.4";
...
universe.selection_policy.global_balance_note = "Slots 71, 74, 78 and 79 promote Al-Hilal, Al-Nassr, Inter Miami and Al Ahly in place of incomplete South American imports. The displaced clubs and Club América remain in reserve slots.";
universe.clubs.sort((a, b) => Number(a.slot) - Number(b.slot));

await writeFile(path, JSON.stringify(universe, null, 2) + "\n", "utf8");
console.log(changed ? "Promoted complete global clubs into the Top 80." : "Global Top 80 promotion already applied; no slot changes needed.");
console.log("Top 80 additions: Al-Hilal SFC, Al-Nassr FC, Inter Miami CF, Al Ahly SC.");
